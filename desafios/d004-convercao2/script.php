...
<body>
    <section>
        ...
        $date = date('m-d-Y');
        //
        $url = "https://olinda.bcb.gov.br/olinda/servico/PTAX/versao/v1/odata/CotacaoDolarDia(dataCotacao=@dataCotacao)?@dataCotacao='12-30-2024'&$top$format";
        ...
        echo "<p>Seus R$" . number_format($real, 2, ",", ".") . " equivalem a <b>US$ $conversao</b></p>";
